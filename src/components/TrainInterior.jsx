...
function TrainShell() {
  return (
    <group>
      {/* Right side wall - kept solid */}
      <mesh position={[2.15, 1.35, -4]} receiveShadow>
        <boxGeometry args={[0.3, 2.7, 16.6]} />
      ...
      {/* Left side wall - removed for cutaway view */}

      {/* Floor */}
      <mesh position={[0, 0, -4]} receiveShadow>
        <boxGeometry args={[4.6, 0.05, 16.6]} />
        <meshStandardMaterial
          color="#1b2432"
          metalness={0.65}
          roughness={0.35}
      ...
      {/* Ceiling */}
      <mesh position={[0, 2.7, -4]} receiveShadow>
        <boxGeometry args={[4.6, 0.05, 16.6]} />
        <meshStandardMaterial
          color="#1b2432"
          metalness={0.65}
      ...
      {/* Interior walls - right side only */}
      <mesh position={[1.9, 1.3, -4]}>
        <boxGeometry args={[0.5, 2.5, 16.2]} />
        <meshStandardMaterial
          color="#f2f5fa"
          roughness={0.9}
          side={THREE.BackSide}
...
function Windows({ positions }) {
  return (
    <>
      {/* Left side windows removed for cutaway view */}

      {/* Right side windows only */}
      {positions.map((z, index) => (
...
function OverheadStorage() {
  return (
    <>
      {/* Left side overhead storage removed for cutaway view */}

      {/* Right side overhead storage only */}
